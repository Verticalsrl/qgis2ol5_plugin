...
class OpenLayersWriter(Writer):
    ...
    def writeOL(cls, iface, feedback, layers, groups, popup, visible,
        ...
        with open(os.path.join(folder, "resources", "qgis2ol5.js"),
                  "w") as f:
...
def getCSS(geocode, geolocateUser, controlCount):
    ...
    extracss += """href="./resources/ol3-layerswitcher.css">
        <link rel="stylesheet" """
    extracss += """href="./resources/qgis2ol5.css">"""
    if geocode:
...
def getJS(osmb):
    ol3qgis2ol5js = """<script src="./resources/qgis2ol5.js"></script>
        <script src="./resources/Autolinker.min.js"></script>"""
    if osmb != "":
        ol3qgis2ol5js += """
        <script>{osmb}</script>""".format(osmb=osmb)
    return ol3qgis2ol5js
...
def getExpJS():
    return """
        <script src="resources/qgis2ol5_expressions.js"></script>"""
